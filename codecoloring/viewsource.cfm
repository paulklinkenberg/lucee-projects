...
<body>
	<p style="border:1px solid #000;padding:10px;margin: 10px 5px;text-align:center; font:12px Arial;">
		...
		This file is part of <a href="http://www.coldfusiondeveloper.nl/post.cfm/my-supreme-coldfusion-code-coloring">The coldfusion color coding project</a>!<br /><br />
		<em>The code is colored using the <a href="http://www.coldfusiondeveloper.nl/post.cfm/my-supreme-coldfusion-code-coloring">Coldfusion code coloring component</a>.</em>
	</p>
