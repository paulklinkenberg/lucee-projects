...
<!--- 
	<cfdns action="getaddress" host="" />
	<cfdns action="gethostname" ip="" />
	<cfdns action="getaddress" host="" type="MX" />
	<cfdns action="getdata" host="abc.com" type="MX" output="raw|xml|array|query" />
	<cfdns action="getdata" host="" type="A" class="IN" />
	<cfdns action="lookup" host="" server="dnsserver.ss.com" port="53" tcp="1|0" retries="3" timeout="5" />
 --->		
