...
<cfoutput>
	...
	<cfset dirs = "" />
	<h3>Path: <a href="/svn.cfm?repositorypath=">[root]/</a>
		<cfif len(filepath)>
			<cfloop list="#getdirectoryFromPath(filepath)#" index="dir" delimiters="/">
				<a href="/svn.cfm?repositorypath=#dirs##dir#/">#dir#/</a>
				<cfset dirs=dirs&dir&"/" />
			</cfloop>
		</cfif>
		<cfif not variables.isdir><a href="/svn.cfm?repositorypath=#filepath#">#getFileFromPath(filepath)#</a></cfif>
	</h3>
</cfoutput>
...
<cfif variables.action eq "diff">
	<cfoutput>
		<p>You may also view the <cfif FullDiff><a href="/svn.cfm?repositorypath=#Left(url.repositorypath,Len(url.repositorypath)-1)#">unified diff</a><cfelse><a href="/svn.cfm?repositorypath=#url.repositorypath#f">full diff</a></cfif>.</p>
...
<cfelseif variables.action eq "showfile">
	<cfoutput>
		<p>You are viewing the contents of #FilePath#, revision #Version#
			<br />
			<a href="/svn.cfm?repositorypath=#filePath#">&laquo; back to the file's overview page</a>
			&nbsp;
			<a href="/svn.cfm?repositorypath=#filePath#:#version#&amp;download=1">download this file</a>
		</p>
				...
				<cfloop query="f">
					...
					<tr class="#EvenOdd[IncrementValue(CurrentRow MOD 2)]#" valign="top">
						...
						<td nowrap="nowrap" class="num links">
							<cfif kind eq "file">
								<a href="/svn.cfm?repositorypath=#FilePath#<cfif variables.isDir>#Path#</cfif>:#Revision#&amp;download=1">download</a>
							</cfif>
							<cfif variables.isDir>
								<a href="/svn.cfm?repositorypath=#FilePath##f.path#<cfif Kind EQ 'dir'>/</cfif>"><cfif Kind EQ 'dir'>Open folder<cfelse>log</cfif></a>
							</cfif>
							<cfif listfindnocase("xml,html,htm,css,cfc,cfm,cfml,js,pl,plx,php,php4,php5,asp,aspx,sql,as,mxml", listlast(f.path, '.'))>
								<a href="/svn.cfm?repositorypath=#FilePath#<cfif variables.isDir>#f.Path#</cfif>:#f.Revision#">view</a>
							</cfif>
							#NumberFormat(Revision)#
						</td>
						<cfif NOT variables.isDir><td align="center"><cfif CanDiff AND (CurrentRow LT RecordCount)><a href="/svn.cfm?repositorypath=#Path#:#f.Revision[IncrementValue(CurrentRow)]#:#Revision#f">#DiffGraphic#</a><cfelse> </cfif></td></cfif>
