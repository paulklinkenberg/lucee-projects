...
<cfset variables.viewablefiles = "correctHtmlImageTextFlowTest.mxml" />
<!--- usage: leave empty if all file-extensions may be viewed. Otherwise, use a comma-delimited list. --->
<cfset variables.viewableExtensions = "cfm,cfc,cfml,txt,js,htm,html,mxml" />
...
<cftry>
	<cffile action="read" file="#request.codeFile#" variable="txt" />
	<cfcatch>
...
<body>
	<p style="border:1px solid #000;padding:10px;margin: 10px 5px;text-align:center; font:12px Arial;">
		...
		This file is part of <a href="http://www.coldfusiondeveloper.nl/post.cfm/flash-as3-images-in-htmltext-how-to">the blog post "Images in flash as3 htmlText, part 2; how to display them correctly"</a><br /><br />
		<em>The code is colored using the <a href="http://www.coldfusiondeveloper.nl/post.cfm/my-supreme-coldfusion-code-coloring">Coldfusion code coloring component</a> by <a href="http://www.leeftpaulnog.nl/">Paul Klinkenberg</a>.</em>
	</p>
