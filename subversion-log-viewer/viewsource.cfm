...
<cfset variables.viewablefiles = "showlog.cfm,subversion.cfc" />
...
<body>
	<p style="border:1px solid #000;padding:10px;margin: 10px 5px;text-align:center; font:12px Arial;">
		...
		<strong>Project page:</strong> <a href="http://www.coldfusiondeveloper.nl/post.cfm/subversion-log-viewer-in-coldfusion"><strong>Subversion log viewer in Coldfusion</strong></a><br /><br />
