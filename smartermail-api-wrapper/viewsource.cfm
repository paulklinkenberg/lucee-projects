...
<body>
	<p style="border:1px solid #000;padding:10px;margin: 10px 5px;text-align:center; font:12px Arial;">
		...
		<strong>Project page:</strong> <a href="http://www.railodeveloper.com/post.cfm/smartermail-api-wrapper-coldfusion"><strong>Smartermail API wrapper in Coldfusion</strong></a><br /><br />
		<!--- Please, leave the next line intact; thee are my credits ;-)  Thanks, Paul. --->
		<em>The code is colored using the <a href="http://www.railodeveloper.com/post.cfm/my-supreme-coldfusion-code-coloring">Coldfusion code coloring component</a> by <a href="http://www.railodeveloper.com/">Paul Klinkenberg</a>.</em>
	</p>
