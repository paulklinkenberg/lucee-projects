...
<body>
	<p style="border:1px solid #000;padding:10px;margin: 10px 5px;text-align:center; font:12px Arial;">
		...
		This file is part of the <a href="http://www.coldfusiondeveloper.nl/post.cfm/toxml-function-for-coldfusion">toXML() function for Coldfusion blog post</a>.<br /><br />
